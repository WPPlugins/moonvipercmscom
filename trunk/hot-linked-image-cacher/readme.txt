...
* No manual work required, new directories and cached images are **automatically** created under your plugin directory.
...
No the plugin will automatically generate the folders for you. They will all be placed under the upload folder in your hotlinked-image-cacher folder.
